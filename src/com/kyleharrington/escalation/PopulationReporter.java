...
public class PopulationReporter implements Serializable {
	/**
	 * 
	 */
...
//			System.err.print("\t" + args[k]);
		...
		if( resumeFilename == "" ) {
			...
			System.out.println( "Reporting on population:" );
			System.out.println( "Species count: " + p.numSpecies );
			System.out.println( "Generation: " + p.t );
